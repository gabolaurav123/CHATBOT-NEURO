...
Para confirmar que Seenode esta usando la memoria nueva, revisa `config.promptVersion` en `/api/health`. Debe mostrar una version tipo `NEURO_PROMPT_VERSION=marisa-memory-2026-06-22-v5`. Esa misma marca tambien viaja en las instrucciones enviadas a OpenAI.
