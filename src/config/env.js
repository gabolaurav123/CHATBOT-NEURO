...
const env = {
  ...
  CRM_SECTION: process.env.CRM_SECTION || 'neurotraumas',
  ...
  VIDEO_LINK: process.env.VIDEO_LINK || 'https://drive.google.com/file/d/1gpukjlEwfQMXHN8LD_GN2-IEncwZ3wFy/view?usp=drive_link',
  PDF_LINK: process.env.PDF_LINK || '',
  HOTMART_LINK: process.env.HOTMART_LINK || 'https://pay.hotmart.com/T103515864E',
  HOLOGRAFICAS_PRODUCT_NAME: process.env.HOLOGRAFICAS_PRODUCT_NAME || 'Holográficas / Gimnasio del Cerebro',
  HOLOGRAFICAS_PRICE: numberFromEnv('HOLOGRAFICAS_PRICE', 72),
  HOLOGRAFICAS_VIDEO_LINK: process.env.HOLOGRAFICAS_VIDEO_LINK || 'https://youtu.be/btHy8kSC4E4',
  HOLOGRAFICAS_HOTMART_LINK: process.env.HOLOGRAFICAS_HOTMART_LINK || 'https://pay.hotmart.com/W101807995K',
